...
def sequence2(min_value, max_value):
    for ints in range(min_value, max_value + 1):
        print("sea2:", ints)


def sequence3(min_value, max_value, step_size):
    for ints in range(min_value, max_value + 1, step_size):
        print("sea3:", ints)


# Min egen "optimering"
def sequence3extra(min_value, max_value, step_size=1):
    for ints in range(min_value, max_value + 1, step_size):
        print("sea3extra:", ints)


# Here starts the main program. Call your function here:
sequence2(3, 5)
sequence3(5, 10, 2)
sequence3extra(3, 10, 3)
