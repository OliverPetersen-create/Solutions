...
car1 = {"wheels": 4, "speed": 180}
car2 = {"wheels": 4, "speed": 230}

print(f"Car 1 has {car1["wheels"]} wheels and a top speed of {car1["speed"]} kph.")
print(f"Car 2 has {car2["wheels"]} wheels and a top speed of {car2["speed"]} kph.")
