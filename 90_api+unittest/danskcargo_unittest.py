...
class TestSoftDeletedAircraft(unittest.TestCase):

    def setUp(self):
        self.aircraft_id = dcsql.last_soft_deleted_aircraft

    def test_aircraft_max_cargo_weight(self):
        aircraft = dcsql.get_record(dcd.Aircraft, self.aircraft_id)
